...
- **Business Logic Documentation:** See [`docs/business-logic.md`](docs/business-logic.md) for a comprehensive overview of the platform's business logic and workflow.
